...
static NVGcolor glnvg__gammacorrectColor(NVGcolor c) 	{
#if defined NANOVG_LINEAR_GAMMA
	c.r = powf(c.r, 2.2);
	c.g = powf(c.r, 2.2);
	c.b = powf(c.r, 2.2);
#endif
							   ...
							   NVGscissor* scissor, float width, float fringe, float strokeThr)
{
	...
	frag->innerCol = glnvg__gammacorrectColor(frag->innerCol);
	frag->outerCol = glnvg__gammacorrectColor(frag->outerCol);
