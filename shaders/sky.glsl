...
void main() {
	...
	f_position = inverse(mat3(u_screen_from_local)) * vec3(v_position.x, v_position.y, gl_Position.z);
}
$endif
...
void main() {
	...
	out_color = to_gamma(vec4(final, 1.0));// * 0.25;
}
